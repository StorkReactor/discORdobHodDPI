...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/StorkReactor/">StorkReactor</a><a href="https://github.com/StorkReactor/discORdobHodDPI">/discORdobHodDPI</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
<!-- gbzap-brand-lead -->
**Скачать discORdobHodDPI** — запрет Discord (голос / RTC) без VPN. Актуальная сборка в [Releases](./releases/latest).

<!-- gbzap-pages-link -->
**Страница сборки:** [https://storkreactor.github.io/discORdobHodDPI/](https://storkreactor.github.io/discORdobHodDPI/)

> [!CAUTION]
>
> ### ФЕЙКИ
> Я не веду никакие другие страницы/группы в телеграм/ютуб каналы  
> Если вы наткнулись на что-то вне репозитория `StorkReactor/discORdobHodDPI`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/StorkReactor/discORdobHodDPI/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/StorkReactor/discORdobHodDPI/issues/522)
...
- См. [#765](https://github.com/StorkReactor/discORdobHodDPI/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/StorkReactor/discORdobHodDPI/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/StorkReactor/discORdobHodDPI/discussions/251)
...
- См. также [#252](https://github.com/StorkReactor/discORdobHodDPI/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/StorkReactor/discORdobHodDPI/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/StorkReactor/discORdobHodDPI/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/StorkReactor/discORdobHodDPI/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

](https://github.com/StorkReactor/discORdobHodDPI/graphs/contributors)
